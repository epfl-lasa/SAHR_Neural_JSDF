...
class RRT(RRTBase):
    def __init__(self, X, Q, x_init, x_goal, max_samples, r, prc=0.01, DS_step=None, vel=None,get_dis=None, get_full_dis=None, dim=None):
        """
        ...
        """
        super().__init__(X, Q, x_init, x_goal, max_samples, r, prc, DS_step=DS_step, vel=vel, get_dis=get_dis, get_full_dis=get_full_dis,dim=dim)
